...
-- vim.opt.colorcolumn = "100" -- show bar at 100 chars
...
vim.keymap.set({ "n", "v", "x" }, "<leader>j", "<Cmd>noh<CR>", { desc = "Disable highlight for last search" })
...
-- PackChanged hook for treesitter (must be before first vim.pack.add)
